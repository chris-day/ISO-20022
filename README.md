...
```
uml2semantics -c class.tsv -a attribute.tsv -e enumeration.tsv -n enumerationIndividuals.tsv --datatypes datatypes.tsv --output iso20022.owl --prefix "iso20022:http://iso20022.org/iso20022/,iso20022cd:http://purl.org/iso20022/cd/,iso20022dt:http://purl.org/iso20022/dt/,xsd:http://www.w3.org/2001/XMLSchema#" --ontology-iri "http://iso20022.org/iso20022"
```
